...
public class Sample {
	...
	private static void scannerAllTable(){
		try {
			KuduClient client = new KuduClient.KuduClientBuilder(KUDU_MASTER).build();
			client.deleteTable("MM_TRI_DIR_B");
			//ListTablesResponse tableListResponse = client.getTablesList();
			//List<String> tableList = tableListResponse.getTablesList();
